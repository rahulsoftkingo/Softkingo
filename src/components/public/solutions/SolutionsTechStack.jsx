...
const defaultTechStackData = {
    ...
    subtitle:
        "We leverage the latest frameworks and tools to build robust, high-performance digital solutions that scale with your business.",
    ...
    tabs: [
        {
            ...
            items: [
                ...
                {
                    name: "Tailwind CSS",
                    image: "/images/tech/Tailwind-CSS.png",
                },
                {
                    name: "Redux",
                ...
                {
                    name: "Three.js",
                    image: "/images/tech/Three.js.png",
                },
            ],
        },
...

        {
            ...
            items: [
                {
                    name: "PostgreSQL",
                    image: "/images/tech/PostgresSQL.png",
                },
                {
                    name: "MongoDB",
...

        {
            ...
            items: [
                ...
                {
                    name: "Google Cloud",
                    image: "/images/tech/Google-Cloud.png",
                },
                {
                    name: "Docker",
                ...
                {
                    name: "Kubernetes",
                    image: "/images/tech/Kubernetes.png",
                },
            ],
        },
    ],
...
export default function SolutionsTechStack({ data }) {
    ...
    const techData =
        data?.tabs?.length > 0 ? data : defaultTechStackData;
                ...
                <div className="flex justify-center">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            "
                        >
                            {techData?.tabs?.[activeTab]?.items?.map(
                                (tech, idx) => (
                                    <div
                                        key={`${activeTab}-${idx}`}
                                        className="
