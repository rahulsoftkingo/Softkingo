            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-12 items-start">
                    ...
                    <div className="lg:pt-14">
                        <p className="text-slate-600 font-semibold text-sm leading-relaxed max-w-lg">
                ...
                {/* Tab Navigation */}
                <div className="bg-white rounded-2xl shadow-xl shadow-sky-900/5 overflow-hidden mb-12 border border-white/50">
                    <div className="flex flex-nowrap md:flex-row items-stretch overflow-x-auto no-scrollbar">
                        {tabs.map((tab, index) => (
                            <button
                                key={index}
                ...
                {/* Content Area */}
                <div className="bg-white rounded-2xl p-8 lg:p-20 shadow-2xl shadow-sky-900/5 relative overflow-hidden group border border-white">
