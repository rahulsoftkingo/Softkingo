...
//   // helper: role ke hisaab se default path
//   const getDefaultRouteForRoles = (roles = []) => {
//     if (callbackUrl) return callbackUrl;      // agar kisi protected page se aaya hai
//     if (roles.includes('admin')) return '/admin';
//     if (roles.includes('manager')) return '/admin/leads';
//     if (roles.includes('writer')) return '/admin/blog';
//     if (roles.includes('agent')) return '/admin/tickets';
...
export default async function LoginPage({ searchParams }) {
  ...
  const callbackUrl = sp?.callbackUrl ?? null;
