    ...
    const config = {
        solution: {
            ...
            sections: [
                ...
                { id: 'process', label: '9. Development Roadmap', icon: Settings },
                { id: 'techStack', label: '10. Technology Stack (Tabbed)', icon: Code },  
                { id: 'awards', label: '11. Client Recognition / Awards', icon: Award },
                { id: 'whyNeed', label: '12. Growing Need / Why Choose', icon: HelpCircle },        
                { id: 'portfolio', label: '13. Portfolio', icon: Layout },
