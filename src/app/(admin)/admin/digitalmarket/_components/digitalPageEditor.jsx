...
//         theme: 'purple',                // set to whatever accent color this editor should use
...
//             { id: 'seo', label: '5. SEO Settings', icon: Search },
//             { id: 'pricing', label: '5A. Pricing / Compare Plans', icon: DollarSign },
//             { id: 'pricingCards', label: '5B. Pricing Cards (Solutions Tabs)', icon: CheckCircle2 }, 
//             // { id: 'industries', label: '4. Industries We Serve', icon: Layers },  
//             { id: 'stats', label: '6. Stats Section', icon: BarChart3 },
//             { id: 'awards', label: '7. Awards Section', icon: Award },
//             { id: 'consultation', label: '8. Consultation CTA', icon: TrendingUp },
//             { id: 'tech', label: '9. Tech Stack', icon: Code },
//             { id: 'process', label: '10. Our Process', icon: Settings },
//             { id: 'highlight', label: '11. Solution Highlight', icon: Zap },
//             { id: 'portfolio', label: '12. Portfolio', icon: Globe },
//             { id: 'solutions', label: '13. Industry Solutions', icon: Grid },
//             { id: 'user-guide', label: '14. User Guide', icon: BookOpen },
//             { id: 'faq', label: '15. FAQ Section', icon: HelpCircle },
//             { id: 'blogs', label: '16. Blog Section', icon: MessageSquare },
//             { id: 'inquiry', label: '17. Inquiry Section', icon: MessageSquare },        
//         ]
//     };

//     const themeColor = config.theme || 'sky';
...
//     // Keep formData in sync if `data` prop arrives/changes after mount (e.g. async fetch in edit mode)
//     useEffect(() => {
//         if (data) {
//             setFormData({
//                 title: '',
...
//         setLoading(true);
//         try {
//             const payload = { ...formData, type: 'digital' };
//             const isEdit = !!formData.id;
//             const apiEndpoint = isEdit ? `/api/admin/digital/${formData.id}` : "/api/admin/digital";
...
//                 }
//             } else {
//                 const savedData = result.data || result.page || result.digital;
...
//     // path splitting update helper -- e.g. "hero.heroTitle" -> content.hero.heroTitle
...
//                         <input
//                             className="w-full p-2.5 bg-white rounded-lg border border-slate-200 text-sm font-bold"
