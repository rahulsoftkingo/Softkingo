...
// export default function EditHirePage() {
//   const router = useRouter();
//   const params = useParams(); // App Router hook [web:106]
//   const id = params?.id;
...
//       const page = data.page;
//       const c = parseJsonMaybe(page.contentJson);
...
//         heroBg: c.heroBg || '/images/hire/h-bg.png',
...
//         aboutTitle: c.aboutTitle || page.title || '',
//         aboutSubtitle: c.aboutSubtitle || page.excerpt || '',
...
//       setSlugLocked(true);
//     } catch (e) {
//       console.error('Load hire page error', e);
...
//                     type="button"
//                     onClick={load}
//                     className="px-3 py-1.5 text-xs rounded-lg border border-slate-300 hover:bg-slate-50 inline-flex items-center gap-2"
//                   >
