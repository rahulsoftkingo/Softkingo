...
//                 <h2 className='font-bold text-3xl 2xl:text-4xl text-sky-800 mb-2 border- w-full text-start border-primary'>{craftings.name}</h2>
...
//                   <h3 className='font-bold text-3xl 2xl:text-4xl text-sky-800 mb-2 text-start border-primary'>{craftings.name}</h3>
...
//               <h3 className=' text-xl 2xl:text-2xl text-sky-700 font-semibold'>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4 mt-10 md:mt-14">
          {craftings.map((item, i) => (
            ...
            >
              <h3 className="font-bold text-2xl 2xl:text-3xl text-sky-800 mb-1">
                {item.name}
              </h3>
