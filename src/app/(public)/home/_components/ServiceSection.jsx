// src/app/(public)/home/_components/ServiceSection.jsx
...
export default function ServicesSection() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 pb-10 md:py-16 md:pb-16 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8">
          ...
          <Link href={active?.link || "/services"} className="group flex flex-col items-center justify-center">
            <div className="flex flex-col items-center cursor-pointer">
              <div
                className="bg-white p-4 rounded-2xl shadow-md border border-sky-900 flex items-center justify-center md:w-28 md:h-28 w-20 h-20 mb-4 transition-all duration-500 ease-in-out group-hover:rounded-full group-hover:border-primary group-hover:text-primary"
              >
                <i
                  className="text-6xl text-sky-900 transition-colors duration-500 ease-in-out group-hover:text-primary"
                >
                  {active?.icon}
                </i>
              </div>
              ...
              <h4
                className="text-xl font-bold text-sky-900 mb-2 text-center transition-colors duration-500 ease-in-out group-hover:text-primary"
              >
                {active?.title}
              </h4>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-row gap-3 overflow-x-auto hide-scrollbar whitespace-nowrap px-2">
              {(active?.technologies || []).map((tech) => (
                <div
                  key={tech.name}
                  className="inline-flex flex-col items-center px-4 py-2 bg-sky50 text-sky-700 rounded-full font-medium whitespace-nowrap"
                >
