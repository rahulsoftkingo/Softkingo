...
//   const baseScreens = currentCategory.screens;
//   const infiniteScreens = [...baseScreens, ...baseScreens, ...baseScreens];

//   useEffect(() => {
//     const carousel = carouselRef.current;
//     if (!carousel || !baseScreens.length) return;
...
//               src={currentCategory.screens[selectedScreen].image}
//               alt={currentCategory.screens[selectedScreen].name}
//               fill
...
//           </h3>
//           {currentCategory.screens.map((screen, i) => {
