export const BLOG_SECTIONS = {
  ...
  //   slugBase: "/ebooks",
  //   types: ["ebook"],
  //   heroBg: "/images/insights/hero-ebooks.png",
  //   heroLabel: "Softkingo ebooks",
  //   heroHeading: "Step‑by‑step product playbooks",
  //   heroSub:
  //     "Structured guides to plan, build and scale web and mobile products.",
  //   listHeading: "All ebooks",
  //   emptyText: "No ebooks available yet.",
  //   featuredCta: "View ebook →",
  //   newsletterList: {
  //     name: "Ebooks Newsletter",
  //     slug: "ebooks-newsletter",
  //     description: "Get updates when new ebooks go live.",
  //   },
  // },
  "press-releases": {
