...
export default async function HireSlugPage({ params }) {
  ...
  // TODO: future me page.contentJson se sections parse kar sakte ho.
  // Abhi layout static data + Page title/excerpt use karega.

  const features = [
    { title: 'People Cohesion', description: 'Creating a collaborative atmosphere where individuals work and align with goals.', icon: '👥' },
    { title: 'Team Leadership', description: 'Taking a visionary and quiet approach by consistently delivering.', icon: '🎯' },
    { title: 'Team Build Up', description: 'Building the capability of our clients to attain learning growth.', icon: '🚀' },
    { title: 'Strategy', description: 'Providing superior creativity in employee benefits plan design.', icon: '💡' },
    { title: 'Communication', description: 'Keeping our clients by maximizing the performance of their organization.', icon: '💬' },
    { title: 'Find A Job', description: 'Recruiting the right people who uphold corporate and wisdom to deliver.', icon: '🔍' },
  ];
  ...
  const services = [
    {
      title: 'Transparent',
      icon: <BsTransparency size={64} />,
      description: 'Set the rules for your journey by negotiating with us directly. Transparency with clients is our motto.',
      bg: 'from-sky-500 to-sky-600',
    },
    {
      title: 'Productive',
      icon: <BsFileEarmarkBarGraph size={64} />,
      description: 'Enhance your team with distractions-spared developers and bring strong waves of productivity.',
      bg: 'from-emerald-500 to-emerald-600',
    },
    {
      title: 'To the point',
      icon: <GiBullseye size={64} />,
      description: 'Find the perfect remote developers for the busy market. Just tailored services to your needs.',
  ...
  const models = [
    {
      title: 'Full-time',
      icon: <CiClock1 className="w-10 h-10 text-sky-300" />,
      description: 'Hire dedicated developers to work exclusively on your project. Ideal for long-term and large-scale development needs.',
      features: ['8 hrs/day', 'Monthly billing', 'Team integration'],
      buttonText: 'Hire Now',
    },
    {
      title: 'Part-time',
      icon: <TbCalendarClock className="w-10 h-10 text-sky-200" />,
      description: 'Perfect when you need experts for a few hours a day. Get dedicated help without long-term commitments.',
      features: ['4 hrs/day', 'Flexible slots', 'Reduced cost'],
      buttonText: 'Hire Now',
    },
    {
      title: 'Hourly',
      icon: <CiTimer className="w-10 h-10 text-slate-200" />,
      description: 'Hire top developers on-demand for tasks, testing, or urgent fixes. Pay only for the time you use.',
      features: ['Time-based', 'No contract', 'Budget-friendly'],
      buttonText: 'Hire Now',
    },
  ];
  ...
  const morebenefits = [
    { title: 'Experienced & Skilled Resources', desc: 'You can hire a team of experienced professionals who have great domain expertise.' },
    { title: 'Cost effective & On-time Delivery', desc: 'When you hire dedicated developers from us, just remain assured of timely completion.' },
    { title: 'Communication via Skype/Email/Phone', desc: 'You can communicate with your team in real-time using any convenient methods.' },
    { title: 'Code & Backup Management', desc: 'We have robust code and backup management in the case of any unwanted issues.' },
    { title: 'Flexible Pricing & Working Models', desc: 'We offer flexibility in pricing and scalability when you hire dedicated developers.' },
    { title: 'No Expenses on Training & Retaining', desc: 'You can save big on training and retaining employees by hiring a team of developers.' },
    { title: 'Daily/Weekly Reporting', desc: 'You can stay updated with the project status through regular reporting from the team.' },
    { title: 'Dedicated Lead as Single Point of Contact', desc: 'We assign a dedicated lead for your team of developers as a single point of contact.' },
    { title: 'Update and Tracking via PMS', desc: 'You can track your project in real time using advanced Project Management Software.' },
    { title: 'Secured & Fail-safe Environment', desc: 'Your confidential corporate data is completely safe when we work on your project.' },
  ];

  return (
    <main className="relative bg-white overflow-x-hidden">
      {/* Hero – uses page.title / excerpt */}
      <section className="relative w-full">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="absolute inset-0 -z-10">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-sky-950/90 via-sky-900/80 to-transparent" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_minmax(320px,380px)] gap-10 items-start">
            <div className="text-white space-y-8">
              <p className="inline-flex items-center gap-2 text-xs font-semibold bg-white/10 px-4 py-1.5 rounded-full border border-sky-400/40">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-white/5 border border-sky-500/30 rounded-2xl px-4 py-3">
                  <p className="text-xs text-sky-200">Average Hiring Time</p>
                  <p className="text-lg font-semibold">48 Hours</p>
                </div>
                <div className="bg-white/5 border border-sky-500/30 rounded-2xl px-4 py-3">
                  <p className="text-xs text-sky-200">Developers Network</p>
                  <p className="text-lg font-semibold">100+ Experts</p>
                </div>
                <div className="bg-white/5 border border-sky-500/30 rounded-2xl px-4 py-3">
                  <p className="text-xs text-sky-200">Client Satisfaction</p>
                  <p className="text-lg font-semibold flex items-center gap-1">
                    4.9/5 <FaThumbsUp className="w-4 h-4 text-emerald-400" />
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 md:-mt-16 relative z-10">
          <div className="bg-white rounded-2xl shadow-2xl border border-sky-100 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {features.map((f, i) => (
              <div
                key={i}
              ...
              >
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-sky-50 flex items-center justify-center text-xl">
                  {f.icon}
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_minmax(320px,380px)] gap-10 items-start">
          <div>
            ...
            <p className="text-slate-600 mb-4 text-sm md:text-base leading-relaxed">
              {page.excerpt ||
                'Softkingo provides experienced front-end developers to build highly interactive web and mobile apps with modern UI/UX.'}
            </p>
            <p className="text-slate-600 mb-6 text-sm md:text-base leading-relaxed">
              Our engineers have experience in UX/UI design, implementation, and optimization of intuitive interfaces and modern front-end architectures.
            </p>
            ...
            {steps.map((step, index) => (
              <div
                ...
                className={`px-4 py-6 text-center ${
                  index < steps.length - 1 ? 'md:border-r border-white/30' : ''
                }`}
              >
              ...
              >
                ...
                <p
                  className={`text-sm leading-relaxed ${
                    s.textDark ? 'text-slate-700' : 'text-white/90'
                  }`}
                >
                  {s.description}
                </p>
      ...
      {/* models + why hire */}
      <section className="max-w-7xl mx-auto bg-white">
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-sky-50 via-white to-sky-50">
          <div className="max-w-7xl mx-auto">
              ...
              {models.map((m, i) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    <div className="bg-white/10 p-3 rounded-full">{m.icon}</div>
