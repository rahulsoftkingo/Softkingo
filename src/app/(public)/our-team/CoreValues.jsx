                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center">
                        <CommonTitle
                            ...
                            subtitle="At Softkingo, our values are the guiding principles that drive our innovation, integrity, and commitment to delivering exceptional digital results."
                        />
                    </div>
