...
import { Linkedin, Quote, Layout, Smartphone, Database, Heart, Globe, Coffee, ArrowRight, Star } from 'lucide-react';
            ...
            <section className="py-24 bg-gradient-to-b from-white to-sky-50 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-20 mb-20">
                    <div className="relative inline-block">
                        ...
                        <div className="absolute top-full left-0 w-6 h-4 bg-sky-800 -z-10 skew-x-[45deg] origin-top-left"></div>
                    </div>
                </div>
